...
df_05 %>%
  ...
  ggplot(aes(x = fecha, 
    ...
    labs(title = "Evolución de la Violencia Homicida en México",
         subtitle = "Homicidos dolosos registrados por mes en cada Entidad Federativa, de enero de 2016 a marzo de 2022.",
         x = NULL,
         y = NULL,
         ...
         fill = "Número de Homicidios por Mes") +
    scale_y_discrete(expand = c(0, 0)) +
    scale_x_date(expand = c(0, 0)) -> be01
